...
class AzureSpatialAnchorsManager {
    ...
    public static final String SpatialAnchorsAccountId = "Sdc5d51fa-6474-4e75-810e-65c0acaefbe8";

    // Set this string to the account key provided for the Azure Spatial Service resource.
    public static final String SpatialAnchorsAccountKey = "E1S4+U33gXRG+G052727s0uwWEWS+N4tK73K8Hs1gqs=";
